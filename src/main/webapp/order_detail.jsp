    ...
    <c:if test="${not empty order}">
        <div class="order-detail-card">
            ...
            <div class="order-total-bar">
                <span>订单总金额：<strong class="total-price">¥${order.totalPrice}</strong></span>
            </div>
        </div>

        <p style="margin-top:20px;"><a href="${pageContext.request.contextPath}/order?action=list" class="btn">← 返回订单列表</a></p>
    </c:if>
</section>
